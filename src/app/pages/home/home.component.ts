...
import { AdContainerComponent } from '../../shared/components/ui/ad-container/ad-container.component';
...
export class HomeComponent {
  ...
  getCategoryIconStyles(categoryTitle: string): string {
    ...
    return (
      styleMap[categoryTitle] || 'bg-gradient-to-br from-gray-500 to-gray-600'
    );
  }
}
